...
const apiKey = 'bc059016381ce027cf4a3265f541aa11'; // API key without query parameters
const units = 'imperial'; // Query parameter for units

// When making API requests, include the units parameter separately like this:
